...
fun CharacterDetailScreen(
    ...
    val character = viewmodel.characterDetails.value
    val collection by dbViewModel.collection.collectAsState()
    ...
    LaunchedEffect(key1 = Unit) {
        dbViewModel.setCurrentCharacterId(character?.id)
    }
    ...
    Column(
        ...
        Button(onClick = {
            if (!inCollection && character != null) {
                dbViewModel.addCharacter(character)
            }
